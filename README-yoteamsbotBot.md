...
3. Give the bot a handle (ex: `yoteamsbotBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://testbot1app.azurewebsites.net/api/messages`
